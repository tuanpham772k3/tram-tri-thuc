...
const CommentItem = ({
  ...
  return (
    <div
      key={comment._id}
      className={`bg-white rounded-xl p-4 shadow-sm border border-gray-100 transition-all duration-300 ease-in-out ${
        level > 0 ? "ml-8 mt-4" : ""
      } hover:shadow-md`}
    >
      {isEditing ? (
          ...
          <div className="flex items-center mb-2">
            <div>
              ...
              <p className="text-xs text-gray-500">
                ...
                {comment.isReported && (
                  <span className="ml-1 text-red-500 font-medium">(Đã báo cáo)</span>
                )}
              </p>
            </div>
          </div>
            ...
            <div className="flex gap-2 items-center text-sm mt-3 pt-3 border-t border-gray-100">
              ...
              {!canEditOrDelete && (
                <button
                  ...
                  className={`flex items-center space-x-1 px-3 py-1 bg-orange-50 text-orange-700 rounded-lg hover:bg-orange-100 transition-colors duration-200 font-medium ${
                    comment.isReported ? "opacity-50 cursor-not-allowed" : ""
                  }`}
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M3.293 6.707a1 1 0 011.414 0L10 11.586l5.293-5.293a1 1 0 111.414 1.414L11.414 13l5.293 5.293a1 1 0 01-1.414 1.414L10 14.414l-5.293 5.293a1 1 0 01-1.414-1.414L8.586 13 3.293 7.707a1 1 0 010-1.414z"
                      clipRule="evenodd"
                    />
                  </svg>
                  <span>Báo cáo</span>
          ...
          {replyContent[comment._id] !== undefined && (
            <div className="mt-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
              ...
              <div className="flex gap-3 mt-3 justify-end">
                ...
                <button
                  onClick={() =>
                    setReplyContent((prev) => ({ ...prev, [comment._id]: undefined }))
                  }
                  className="bg-gray-400 text-white px-4 py-2 rounded-lg hover:bg-gray-500 transition-colors duration-200 text-sm font-medium shadow-md"
                >
                  Hủy
