            ...
            >
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...
                      categoryId: e.target.value === "vip" ? "" : prev.categoryId, // Reset categoryId nếu chọn VIP
                    }))
                  }
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 ${
                    formData.accessLevel === "vip" ? "bg-gray-100 cursor-not-allowed" : ""
                  }`}
                >
            ...
            >
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Chỉ hỗ trợ định dạng PDF</p>
                </div>
                {formData.file && (
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Bạn vẫn giữ toàn bộ quyền sở hữu đối với tài liệu của mình. Bằng việc
                upload, bạn cấp cho chúng tôi quyền lưu trữ và phân phối tài liệu theo
                điều khoản sử dụng.
              </p>
            </div>
