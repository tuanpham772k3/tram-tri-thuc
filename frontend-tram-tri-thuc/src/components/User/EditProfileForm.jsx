...
const EditProfileForm = () => {
  ...
  const validateForm = () => {
    ...
    if (
      formData.avatar &&
      !/^https?:\/\/.*\.(png|jpg|jpeg|gif|webp)$/i.test(formData.avatar)
    ) {
          ...
          {isEditing ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                ...
                />
                {formErrors.country && (
                  <p className="mt-2 text-sm text-red-500">{formErrors.country}</p>
                )}
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                ...
                <p className="text-gray-900">{formData.address || "Chưa có địa chỉ"}</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                <h3 className="text-sm font-medium text-gray-500 mb-2">Quốc gia</h3>
                <p className="text-gray-900">{formData.country || "Chưa có quốc gia"}</p>
              </div>
            </div>
          )}
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-8">
                  Bạn có chắc muốn xóa tài khoản? Hành động này không thể hoàn tác và tất
