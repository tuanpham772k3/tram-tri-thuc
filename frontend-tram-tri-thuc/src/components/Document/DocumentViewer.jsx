                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-gray-600 max-w-sm mx-auto leading-relaxed">
                            Tài liệu này không có file đính kèm để xem trước. Vui lòng kiểm tra lại
                            hoặc liên hệ người tải lên.
                        </p>
                    </div>
                </motion.div>
            );
            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className={`relative mt-8 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 max-w-6xl w-full mx-4 ${isFullscreen ? "h-[95vh]" : ""} ${className}`}
                    >
                        {/* Control Bar */}
