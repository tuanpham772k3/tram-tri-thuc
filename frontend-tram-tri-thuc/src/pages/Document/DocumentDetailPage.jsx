                        ...
                        <div className="flex flex-wrap items-center gap-4 mt-8">
                            ...
                            <motion.button
                                ...
                                className={`flex items-center space-x-3 px-8 py-4 rounded-2xl font-semibold transition-all duration-300 shadow-lg ${
                                    isFavorite
                                        ? "bg-gradient-to-r from-red-500 to-pink-500 text-white shadow-red-500/25 hover:shadow-xl hover:shadow-red-500/30"
                                        : "bg-white/80 text-gray-700 hover:bg-white border border-gray-200 shadow-gray-200/50 hover:shadow-xl hover:shadow-gray-300/30"
                                }`}
