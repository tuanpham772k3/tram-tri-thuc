    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                // Kiểm tra unwrap result từ createAsyncThunk
                const result = response.payload;
                if (result && result.userId) {
                    navigate(`/auth/verify/${result.userId}`);
                }
            } catch (error) {
                        ...
                        <div className="order-2 lg:order-1 space-y-12">
                            ...
                            <div className="text-center lg:text-left">
                                ...
                                <p className="text-xl font-['Montserrat'] text-purple-100 mb-8 max-w-2xl drop-shadow leading-relaxed tracking-wide">
                                    ...
                                    ,{" "}
                                    <span className="text-pink-300 font-medium">sách điện tử</span>{" "}
                                    và{" "}
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-start space-x-4">
                                                ...
                                                <div
                                                    className={`flex-shrink-0 opacity-0 transform translate-x-2 transition-all duration-300 ${
                                                        isActive
                                                ...
                                                >
                                                    <FaArrowRight
                                                        className={`w-4 h-4 ${isActive ? "text-white" : "text-purple-200"}`}
                                                    />
                                                </div>
                                            </div>
                                        </div>
