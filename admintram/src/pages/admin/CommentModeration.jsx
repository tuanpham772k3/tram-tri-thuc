  ...
  const [comments, setComments] = useState([
    {
      id: 1,
      content:
        "Bài viết rất hay và bổ ích, cảm ơn tác giả đã chia sẻ những kiến thức quý báu này.",
      author: "Nguyễn Văn A",
      documentId: 1,
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-600 text-lg">
              Kiểm duyệt và quản lý các bình luận từ người dùng
            </p>
          </div>
                    ...
                    <div className="relative">
                      ...
                      <div
                        className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-white ${
                          comment.status === "active" ? "bg-emerald-400" : "bg-red-400"
                        }`}
                      ></div>
                    </div>
                    <div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            <div className="text-slate-600 flex items-center gap-2">
              ...
              <span className="font-semibold text-slate-800">
                1-{filteredComments.length}
              </span>{" "}
              trong số{" "}
              <span className="font-semibold text-slate-800">{comments.length}</span> bình
              luận
            </div>
