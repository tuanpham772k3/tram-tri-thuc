...
//         console.log(`Category created by ${req.user.email}: ${name}`);
//         res.status(201).json({
//             success: true,
...
//         console.log(`Category updated by ${req.user.email}: ${category.name}`);
//         res.status(200).json({
//             success: true,
...
//         console.log(`Category deleted by ${req.user.email}: ${category.name}`);
