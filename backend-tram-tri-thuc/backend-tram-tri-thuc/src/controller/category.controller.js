...
exports.getCategories = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Không thể lấy danh sách danh mục." });
  }
};
...
exports.getCategoryBySlug = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Không thể lấy thông tin danh mục." });
  }
};
...
exports.createCategory = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Không thể tạo danh mục." });
  }
};
...
exports.deleteCategory = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Không thể xóa danh mục." });
  }
};
